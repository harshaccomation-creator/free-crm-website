...
function installEmployeeLeftAlignFix() {
  ...
  style.textContent = `
    ...
    .ld-activity-row{grid-template-columns:48px minmax(0,1fr) 132px!important;gap:14px!important;padding:13px 0!important;}
    .ld-activity-row:before{left:23px!important;top:48px!important;bottom:-13px!important;}
    .ld-activity-icon{position:relative!important;width:48px!important;height:48px!important;border-radius:16px!important;font-size:0!important;line-height:0!important;overflow:hidden!important;display:grid!important;place-items:center!important;}
    ...
    .ld-activity-icon:after{content:""!important;display:block!important;visibility:visible!important;opacity:1!important;position:relative!important;z-index:5!important;width:20px!important;height:20px!important;background:currentColor!important;mask:var(--activity-icon) center/contain no-repeat!important;-webkit-mask:var(--activity-icon) center/contain no-repeat!important;}
