...
function formatActivityTime(date, time) {
  ...
  return stamp.toLocaleString('en-IN', { day: '2-digit', month: 'short', hour: '2-digit', minute: '2-digit' });
}
...
export default function LeadDetailPage({ leadId }) {
  ...
  const [activityForm, setActivityForm] = useState({ type: 'call', title: '', note: '', date: new Date().toISOString().slice(0, 10), time: '10:30' });
