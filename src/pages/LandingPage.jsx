...
const formModals = new Set(['Book a Demo', 'Start Free Trial', 'Contact Sales', 'Chat', 'Choose Starter Plan']);
...
export default function LandingPage() {
  ...
  const modalCopy = MODAL_COPY[modal] || 'Open the related SalesFlow section to continue.';
  ...
  return (
    <div className="landing-page">
      ...
      <LandingModules action={action} openModal={setModal} openLoginPage={openLoginPage} openInfoPage={openInfoPage} />
