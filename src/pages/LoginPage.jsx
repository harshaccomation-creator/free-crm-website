      ...
      <section className="login-card-wrap">
        <aside className="login-visual-panel">
          <div className="login-brand">
            ...
            <div><strong>Sales<span>Flow</span></strong><small>Grow your business, build better relationships.</small></div>
          </div>

          <div className="crm-illustration" aria-label="SalesFlow CRM illustration">
            <div className="crm-board"><div className="crm-sidebar"><i /><i /><i /><i /><i /></div><div className="crm-screen"><div className="crm-stats"><div><b>1,250</b><span>Leads</span></div><div><b>850</b><span>Deals</span></div><div><b>$24,500</b><span>Revenue</span></div></div><div className="crm-main-panels"><div className="chart-panel"><span className="panel-title">Sales Overview</span><div className="chart-grid" /><div className="chart-line line-one" /><div className="chart-line line-two" /></div><div className="activity-panel"><span className="panel-title">Recent Activities</span>{[1, 2, 3].map((row) => <div className="activity-row" key={row}><i /><div><span /><span /></div></div>)}</div></div></div></div>
            <div className="illustration-dots" />
            <div className="desk-scene"><div className="desk-table" /><div className="desk-leg left" /><div className="desk-leg right" /><div className="laptop"><div className="laptop-screen"><span /><span /><span /></div></div><div className="person"><div className="person-head" /><div className="person-body" /><div className="person-arm" /><div className="person-chair" /><div className="person-leg one" /><div className="person-leg two" /></div></div>
            <div className="left-plant"><span className="pot" /><i className="leaf one" /><i className="leaf two" /><i className="leaf three" /><i className="leaf four" /></div>
          </div>
        ...
        <section className="login-form-panel">
          <div className="login-form-box">
            <h2>Welcome Back!</h2><p>Please sign in to your account</p>
